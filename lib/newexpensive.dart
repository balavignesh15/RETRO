...
import 'package:livepro/route.dart';
...
class _newexpState extends State<newexp> {
  ...
  List<String> categoryItems = ['Category 1', 'Category 2', 'Category 3', 'Category 4'];
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: (){
                ...
                addItemList();
                Navigator.push(context, MaterialPageRoute(builder: (context) => NextPage(expenseData: expenseData)));
